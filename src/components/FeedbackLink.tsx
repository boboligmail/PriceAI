...
export function GitHubLink({
  ...
  return (
    <a
      ...
      aria-label="打开 ai-home GitHub 仓库"
    >
      <Image
  ...
  return (
    <>
      <button
        ...
        aria-label={`查看 ai-home QQ 交流群加入方式，群号 ${qqGroupNumber}`}
          ...
          <div className="grid gap-4 px-5 py-5 sm:grid-cols-[minmax(0,1fr)_180px] sm:items-start">
            ...
            <div className="rounded-lg border border-[#dfe4e5] bg-white p-2">
              <Image
                ...
                alt={`ai-home QQ 交流群二维码，群号 ${qqGroupNumber}`}
                width={1284}
                height={2289}
...
export function TelegramLink({
  ...
  return (
    <a
      ...
      aria-label="加入 ai-home Telegram 交流群"
    >
      <Image
        ...
        >
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
            ...
            <CommunityPrompt className="mt-4">
              想更快反馈价格、库存、分类问题？也可以加入 ai-home 交流群。
            </CommunityPrompt>
          </div>

...
export const storageOptions = [["0", "硬盘全部"], ["20", "20 GB+"], ["40", "40 GB+"], ["80", "80 GB+"], ["160", "160 GB+"], ["512", "512 GB+"]] as const;
...
export const billingOptions = [["all", "计费全部"], ["spot", "Spot"], ["ondemand", "On-demand"], ["reserved", "Reserved"], ["hour", "按小时"], ["month", "按月"]] as const;
